...
{
	$eid = $_GET['id'];
	$detail = "SELECT * FROM event WHERE eventid = 	'$eid'";
...
if (isset($_POST['addevent'])) 
{
	...
	if (count($errors) == 0){
		$sql = "INSERT INTO event (title, description, category, image) VALUES ('$title','$desc','$cat', '$img_src')";
...
<head>
  ...
  <title>ENBackEnd | Add Event</title>
            ...
            <form role="form" method="post" action="" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter SKU" name="desc">
                </div>
               	 <div class="form-group">
                  <label for="exampleInputPassword1">Quantity</label>
                  <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter quantity" name="desc">
                </div>
               	 <div class="form-group">
                  <label for="exampleInputPassword1">Allergy Info</label>
                  <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter any allergy info the product might have" name="desc">
                </div>
