...
if (isset($_POST['addevent'])) 
{
	...
	$allergy=mysqli_real_escape_string($conn, $_POST['desc']);
	...
	if (count($errors) == 0){
		...
		$sql = "INSERT INTO product (product_name, product_description, product_sku, product_quantity, product_allergy_info, product_image_path) VALUES ('$name','$desc','$sku', '$quantity', '$allergy', '$img_src')";
            ...
            <form role="form" method="post" action="" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputQuantity" placeholder="Enter quantity" name="quantity">
                </div>
               	 <div class="form-group">
